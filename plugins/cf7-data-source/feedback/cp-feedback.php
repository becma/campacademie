<?php
if ( ! class_exists( 'CF7DS_FEEDBACK' ) ) {
	class CF7DS_FEEDBACK {
		...
		public function __construct( $plugin_slug, $plugin_file, $support_link ) {
			...
			add_action( 'wp_ajax_cf7ds_feedback', array( $this, 'feedback_action' ) );
		} // End __construct
		...
		public function feedback_action() {
			if (
				...
				wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['_wpnonce'] ) ), 'cf7-datasource-feedback' )
			) {
				...
				if ( ! isset( $_POST['cf7ds_feedback_anonymous'] ) ) {
